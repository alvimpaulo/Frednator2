...
StandGenerator::StandGenerator()
   ...
   ////qiLogInfo("Motion") << "StandGenerator constructed" << std::endl;
   posGen = (Generator*)(new ActionGenerator("stand"));
   if (!posGen)
      qiLogFatal("Motion") << "stand generator is NULL!" << std::endl;
}

StandGenerator::~StandGenerator() {
   ////qiLogInfo("Motion") << "StandGenerator destroyed" << std::endl;
   delete posGen;
}
...
//   joints.stiffnesses[i++] = 0.0f;  // RElbowRoll
   ////qiLogInfo("Motion") << "Stand Generator" << std::endl;
...
//   ////qiLogInfo("Motion") << "Successfully changed stand generator options" << std::endl;
//   ////qiLogInfo("Motion") << "Stand generator options ignored" << std::endl;
}

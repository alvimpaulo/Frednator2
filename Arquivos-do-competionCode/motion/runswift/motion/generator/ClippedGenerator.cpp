...
ClippedGenerator::ClippedGenerator(Generator* g)
   : generator(g),
     old_exists(false) {
   ////qiLogInfo("Motion") << "ClippedGenerator constructed" << std::endl;
}

ClippedGenerator::~ClippedGenerator() {
   delete generator;
   ////qiLogInfo("Motion") << "ClippedGenerator destroyed" << std::endl;
}
...
JointValues ClippedGenerator::makeJoints(ActionCommand::All* request,
                                         ...
                                         float ballX,
                                         float ballY) {
   ////qiLogInfo("Motion") << "Clipped Generator make joints" << std::endl;

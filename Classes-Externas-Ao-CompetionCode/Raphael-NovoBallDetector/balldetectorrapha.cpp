...
void ballDetectorRapha::run(cv::Mat src, cv::Mat src2, PerceptionData *data){
    ...
    houghCirclesContrast hough(hough_param1, hough_param2, resize_factor, 30, (int)MIN_RADIUS, (int)MAX_RADIUS);
    Mask.setMask(BLACK_L_MAX, WHITE_L_MIN, GREEN_H_MEAN, GREEN_H_VAR, GREEN_S_MIN, 0.5);
